        ...
        <div className="lp-hero__inner">
          <div className="lp-hero__copy">
            ...
            <div className="lp-hero__tags">
              ...
              <span className="lp-hero__tag"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>Results in seconds</span>
